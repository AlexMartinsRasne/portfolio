          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative w-full max-w-md mx-auto">
                <div className="relative aspect-square rounded-full overflow-hidden shadow-glow-ocean border-2 border-ocean-500/30">
                  <img
                    src="/avatar.png"
                    alt={getLocalizedText(aboutData.profile, 'name', language)}
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 avatar-shine" />
                </div>
